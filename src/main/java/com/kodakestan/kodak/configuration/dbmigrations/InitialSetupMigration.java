package com.kodakestan.kodak.configuration.dbmigrations;
...
public class InitialSetupMigration {
    ...
    @ChangeSet(order = "01", author = "initiator", id = "thnx -addAuthorities-v1")
    public void addAuthorities(DB db) {
        DBCollection authorityCollection = db.getCollection("thnx _authority");
    ...
    @ChangeSet(order = "02", author = "initiator", id = "thnx -addUsers-v2")
    public void addUsers(DB db) {
        DBCollection usersCollection = db.getCollection("thnx _user");
